...
abstract class Command implements CommandInterface
{
    ...
    /**
     * @var string Action passed to the command.
     */
    protected $action;
    /**
    ...
    public function make($telegram, $action, $arguments, $update)
    {
        ...
        return $this->handle($action, $arguments);
    }
     ...
     * @return mixed
     */
    protected function triggerCommand($command, $action = null, $arguments = null)
    {
        return $this->getCommandBus()->execute($command, $action ?: $this->action, $arguments ?: $this->arguments, $this->update);
    }

    /**
     * {@inheritdoc}
     */
    abstract public function handle($action, $arguments);
